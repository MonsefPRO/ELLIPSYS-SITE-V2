      ...
      <AnimatePresence>
        {open && (
          <>
            ...
            >
              <div className="relative rounded-2xl border border-white/10 bg-[#0d1829] shadow-2xl overflow-hidden">
                {/* Top gradient bar */}
                      ...
                      <form onSubmit={handleSubmit} className="space-y-3">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder:text-slate-600 focus:outline-none focus:border-blue-500/50 focus:bg-white/8 transition"
                          />
                        </div>
                        <div>
                          <label className="block text-xs font-medium text-slate-400 mb-1.5">
